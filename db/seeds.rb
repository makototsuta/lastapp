...
Map.create!(
  [
    {name: '洋光台マンション（廃墟）', address:'神奈川県横浜市磯子区洋光台5-8-22', content:'「洋光台のマンション」は神奈川では有名な心霊スポットです。ここは特別な事故や事件が起きた場所ではありませんが、一部では怖い噂がささやかれています。', horror_level: '★★★', icon:File.open("#{Rails.root}/app/assets/images/洋光台.jpg")},
    {name: '打越橋', address: '神奈川県横浜市南区唐沢1', content: '自殺の名所としても知られています。そのためか、様々な心霊現象が起こるそうです。', horror_level: '★★', icon:File.open("#{Rails.root}/app/assets/images/打越橋.jpeg")},
    {name: '山神トンネル', address: '神奈川県厚木市七沢', content: '通称「化けトン」と呼ばれており、多くの人に恐れられています。その理由としては諸説あります。まず、昔ここで建設作業員が亡くなるという事故が起こったそうです。その幽霊が今もいるのではないかと考えられます。', horror_level: '★★★★★', icon:File.open("#{Rails.root}/app/assets/images/山神トンネル.jpeg")},
    {name: 'ビジネスホテルトロピカル(廃墟)', address: '神奈川県横浜市都筑区川向町651−1', content: '神奈川県ではよく知られた心霊スポットです。10年以上前に閉業して以来廃墟と化して、多くの人に恐れられています。潰れた理由として、オーナーの自殺が噂されています。また殺人事件やこのホテルで働いていた方が亡くなるなど悪い噂ばかりです。', horror_level: '★★★★', icon:File.open("#{Rails.root}/app/assets/images/ビジネスホテルトロピカル .jpeg")},
    {name: 'ホテルすかいらぶ(廃墟)', address: '神奈川県伊勢原市善波1439', content: 'ここは10年以上前に廃業したホテルですが、女性の幽霊がでることで知られています。その背景として、昔この場所で殺人事件が起きたといわれています。', horror_level: '★★★★', icon:File.open("#{Rails.root}/app/assets/images/ホテルすかいらぶ.jpeg")},
    {name: '緑ヶ丘霊園', address: '神奈川県川崎市高津区下作延5-35-6', content: '夜になるとこの像が動き出すという怖い噂が流れ、ある人がその像を破壊してしまいました。このような経緯から心霊スポットと言われるようになりました。また霊園内でも自殺がよくあるためその霊もでると考えられています。', horror_level: '★★', icon:File.open("#{Rails.root}/app/assets/images/緑ヶ丘霊園.jpeg")},
    ...
    {name: '白金トンネル', address: '東京都品川区上大崎２丁目-７', content: '事故が多発し心霊スポット化。隣の国立科学博物館附属自然教育園は、元は国立予防衛生研究所だったため、その因縁も噂される。', horror_level: '★★★', icon:File.open("#{Rails.root}/app/assets/images/s_MG_9207.jpg")},
...
Event.create!(
  [
    {title: '本家 心霊スポット巡礼ツアー「多魔」', address: '東京都田無駅集合', content: '「多摩」周辺の鬼哭啾啾な心霊スポットをご案内致します。 山岳エリアの知る人ぞ知るスポットから有名スポットまで幅広くご案内させていただきます。 昨年同様に、最恐の怖さを誇るHELLコースをご用意。ご了承ください', outline: '「多摩」周辺の鬼哭啾啾な心霊スポットをご案内致します', icon:File.open("#{Rails.root}/app/assets/images/okiku_hirosige.jpg"), participant_number: '8', day_time_at: 'Sun, 19 July 2020', user_id: '1'},
    {title: '百物語', address: '神奈川県川崎駅集合', content: '今夏も、同じく神奈川にある光蓮寺の本堂をお借りし、夜を徹しての怪談会に挑む。果たして最後までやり遂げることが出来るのか。そして最後の話が語られた時、一体何が起きるのか。それは是非、この会に参加して、あなた自身の目で確かめて頂きたい。', outline: '参加者が順番に怪談を語っていくイベントです', icon:File.open("#{Rails.root}/app/assets/images/ダウンロード.jpeg"), participant_number: '10', day_time_at: 'Sun, 23 August 2020', user_id: '2'},
    {title: '元祖 心霊スポット巡礼ツアー「横浜」', address: '神奈川県横浜駅集合', content: '横浜エリアの知る人ぞ知るスポットから有名スポットまで幅広くご案内させていただきます。 昨年より怖さがバージョンアップしております。ご了承ください。', outline: '「横浜」周辺の幽明異境な心霊スポットをご案内致します。', icon:File.open("#{Rails.root}/app/assets/images/2019summer_img14.png"), participant_number: '12', day_time_at: 'Sun, 26 July 2020', user_id: '3'},
    {title: '野水の毒々オカルトナイト～怪談×心霊×事故物件', address: '東京都新宿 LEFKADA新宿', content: '事故物件の居住者と電話をつなぎ、当事者ならではの悩みなどを聞く、という内容です。そこでイベント当日に電話可能な方を募集します。名前（ペンネーム可）・電話番号を明記の上、メールの件名に【大島TEL参加希望】と付けて、下記までご連絡ください。宜しくお願いします！', outline: '大好評配信中の『野水の毒々ナマ放送』が、１３日の金曜日にレフカダ新宿に出現！', icon:File.open("#{Rails.root}/app/assets/images/RZHQRvy7c4e8NIQ0rbPGtIDKk7MGw1e3w2t7ryHjzyV31mrJ7zavwjmvxVDIQF6h.jpeg"), participant_number: '5', day_time_at: 'Sun, 26 July 2020', user_id: '4'},
    {title: '稲川淳二の怪談ナイト', address: '西東京市保谷こもれびホール メインホール', content: 'ミステリーナイト当日、何らかの怪奇現象が引き起こした不慮の事故に関して主催者は一切の責任を負いませんのであらかじめご了承ください...。', outline: '「今年もアイツらがやってくる・・・」', icon:File.open("#{Rails.root}/app/assets/images/img_03.jpg"), participant_number: '30', day_time_at: 'Sun, 23 August 2020', user_id: '5'}
  ]
)
...
Experience.create!(
  [
    ...
    {title: 'ひとりかくれんぼ', outline: '実行すると怪奇現象に...', content: 'ひとりかくれんぼとは、日本の近代怪談の1つで、いわゆる都市伝説である[1]。ひとり鬼ごっことも呼ばれ、[2] 危険な降霊術（または呪術）とされ、コックリさんよりも危険だとされている。', procedure: '余った糸は、ある程度ぬいぐるみに巻きつけて結ぶ[5][7]。中に入れる米はぬいぐるみの内臓を、赤い糸は血管を表しているともいう[1]。隠れ場所を決めておき、そこに塩水を用意しておく[1][7]。の名前：△△とする）。「次は△△が鬼だから[7]」または「次は△△が鬼[1]」と言い、自分は塩水のある隠れ場所に隠れる', danger_level: '3', number_of_incident: '', icon:File.open("#{Rails.root}/app/assets/images/ひとりかくれんぼ.jpeg")},
